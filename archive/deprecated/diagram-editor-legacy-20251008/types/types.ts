export interface Shape {
  id: string;
  type: "line" | "arrow" | "freehand" | "zone" | "curve";
...
// Annotation types - must be defined before DiagramDocumentV1
...
export interface EditorToolState {
  ...
  playerShape?: "oval" | "rectangle" | "triangle"; // shape type for add-player tool
