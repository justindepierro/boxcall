...
import { FormationBuilderRouter } from "./FormationBuilderRouter";
    ...
    <div className="flex flex-col items-center justify-center h-full p-spacing-xl max-w-2xl mx-auto">
      <div className="w-full space-y-spacing-lg">
        ...
        <div className="flex gap-spacing-md pt-spacing-md border-t border-border-primary">
          <button
            onClick={onCancel}
            className="flex-1 px-3 py-1.5 text-xs bg-surface-card border border-border text-content-primary hover:bg-surface-muted rounded-full font-medium transition-colors"
          >
            Cancel
          </button>
        </div>
