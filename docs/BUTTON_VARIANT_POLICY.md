> DEPRECATED – See `BUTTON_VARIANT_POLICY_v2.md` for current authoritative policy (updated 2025-08-11). File kept one release for historical diff only.
...
- Formal enforcement + migration status tracking.

Open `BUTTON_VARIANT_POLICY_v2.md` for full guidance.
