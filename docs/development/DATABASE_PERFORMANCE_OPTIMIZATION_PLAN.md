...
["formations", playbookId][("formations", "incomplete", playbookId)][ // All formations // Incomplete formations
  ("formations", "review", playbookId)
][("formation", formationId)][("formation", formationId, "opposite")]; // Direction review // Single formation detail // Opposite formation link
```
