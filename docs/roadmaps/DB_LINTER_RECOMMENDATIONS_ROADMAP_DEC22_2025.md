...
- query plans that *should* use the index in production but haven’t yet due to limited workload
...
- Code comments claim tables don’t exist that *do* exist in migrations.
