# Style Audit Summary
Generated: 2025-08-10T11:27:08.735Z
...
| src/components/playbook/PlayBuilder/PlayBuilderWizard.tsx:22 | `inline-block align-bottom bg-white rounded-lg shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-5xl sm:w-full` |
| src/components/playbook/PlayBuilder/PlayBuilderWizard.tsx:24 | `bg-white px-6 py-4 border-b border-slate-200 flex items-center justify-between` |
| src/components/playbook/PlayBuilder/QuickEntry.tsx:221 | `playbuilder-input w-full px-4 py-3 bg-white border-2 border-jade-300 rounded-md focus:ring-2 focus:ring-jade-500 focus:border-jade-500 text-` |
| src/components/playbook/PlayFilters.tsx:40 | `bg-white rounded-lg shadow-sm border border-slate-200` |
