...
async function applyMigration() {
  ...
  try {
    // Read migration file
    const migrationPath = path.join(__dirname, 'database', 'migrations', '20251017_expand_play_types.sql');
    ...
    console.log('   • Trick');
    console.log('   • Draw');
    console.log('   • Any custom type (1-50 chars, letters/numbers/spaces/hyphens)');
