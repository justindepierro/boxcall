...
async function createBackup() {
  ...
  console.log('╚══════════════════════════════════════════════════════════╝\n');
  console.log(`🕐 Start time: ${new Date(timestamp.replace(/-/g, ':')).toLocaleString()}`);
  ...
  console.log('╚══════════════════════════════════════════════════════════╝\n');
  console.log(`Status: ${metadata.success ? '✅ SUCCESS' : '⚠️  PARTIAL FAILURE'}`);
  ...
  Object.entries(metadata.recordCounts)
    ...
    .forEach(([table, count]) => {
      ...
      console.log(`  ${status} ${table.padEnd(25)} ${displayCount.padStart(8)}`);
    });
