...
async function checkPolicies() {
  ...
  try {
    ...
    const { data: _functions, error: funcError } = await supabase.rpc('is_user_team_member', { team_uuid: '00000000-0000-0000-0000-000000000000' });
    ...
    if (membersError) {
      ...
      console.log(`✅ Team members query successful: ${members.length} records`);
    }
