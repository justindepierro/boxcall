...
async function debugDatabase() {
  ...
  try {
    ...
    console.log("✅ Service role - profiles query:", {
      profiles,
      error: profileError,
    });
  } catch (err) {
  ...
  try {
    ...
    console.log("✅ Service role - teams query:", {
      teams: teams?.length,
      error: teamsError,
    });
  } catch (err) {
  ...
  try {
    ...
    console.log("✅ Service role - team_members query:", {
      teamMembers,
      error: membersError,
    });
  } catch (err) {
  ...
  try {
    ...
    console.log("📊 Anon client - profiles query:", {
      profiles,
      error: profileError,
    });
  } catch (err) {
  ...
  try {
    ...
    console.log("📊 Anon client - teams query:", {
      teams: teams?.length,
      error: teamsError,
    });
  } catch (err) {
  ...
  try {
    const { data: policies } = await supabaseService.rpc(
      "get_policies_info",
      {}
    );
