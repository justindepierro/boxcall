...
function findArbitraryFontSizes(filePath: string, project: Project): Replacement[] {
...
async function main() {
  ...
  console.log(`🔍 Scanning ${sourceFiles.length} files for arbitrary font sizes...\n`);
  ...
  console.log(`📊 Found ${allReplacements.length} arbitrary font sizes across ${fileReplacements.size} files\n`);
