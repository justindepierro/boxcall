...
const CustomTooltip: React.FC<{
  ...
  showSuccessRate: boolean;
  showReps: boolean;
}> = ({ active, payload, showSuccessRate, showReps }) => {
            ...
            <div className="flex justify-between gap-4">
              ...
              <Typography
                ...
                className={`font-semibold ${(() => {
                  if (point.successRate >= 75) return "text-success-600";
                  if (point.successRate >= 60) return "text-warning-600";
...
}> = ({ avgConfidence, totalReps, confidenceChange }) => (
  <div className="mt-6 grid grid-cols-3 gap-4 border-t pt-4">
    ...
    <div>
      ...
      <Typography
        variant="body-sm"
        className={`font-semibold ${(() => {
          if (confidenceChange > 0) return "text-success-600";
          if (confidenceChange < 0) return "text-error-600";
          return "text-secondary";
        })()}`}
      >
        {(() => {
          if (confidenceChange > 0) return "↑ ";
          if (confidenceChange < 0) return "↓ ";
          return "→ ";
        })()}
...
const ChartHeader: React.FC<{
  ...
  <div className="mb-4 flex items-start justify-between">
    <div>
      ...
      <Typography variant="body-xs" className="text-secondary">
        {dataLength} weeks of data • {totalReps} total reps
      </Typography>
    </div>
    <div className="text-right">
      ...
      <Typography
        variant="headline-md"
        className={
          latestConfidence >= targetConfidence
            ? "text-success-600"
            : "text-warning-600"
        }
      >
    ...
    <Card className={className}>
      <div className="p-6">
        <ChartHeader
          ...
          totalReps={totalReps}
          latestConfidence={latestPoint.confidence}
