    ...
    >
      <div className="relative">
        ...
        {isEditingData && allowDataEditing && (
          <div className="absolute top-8 left-0 right-0 bg-white dark:bg-navy-800 border border-neutral-200 dark:border-navy-600 rounded-lg p-2 z-10 shadow-lg">
              ...
              {localData.data.slice(0, 5).map((point, index) => (
                <div key={index} className="flex items-center gap-1">
                  ...
                  <input
                    ...
                    className="w-12 px-1 py-0.5 text-xs border border-primary rounded-lg"
                    step="0.1"
                  />
                </div>
              ))}
