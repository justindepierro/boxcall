        ...
        <div className="flex flex-col items-end space-y-3">
          ...
          {isExpanded && (
            <div className="flex flex-col space-y-2 animate-in slide-in-from-bottom-2 fade-in duration-200">
              ...
              <Button
                ...
                className="w-12 h-12 rounded-full bg-text-info text-text-on-primary shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center"
              ...
              <Button
                ...
                className="w-12 h-12 rounded-full bg-text-secondary text-text-on-primary shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center"
          ...
          <Button
            ...
            className={`w-14 h-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center ${
              isExpanded
                ? "bg-text-error text-surface-primary rotate-45"
