  ...
  const userExamples = [
    {
      ...
      description:
        "Platform admin with head coach role and premium subscription",
    },
    {
      name: "John Coach",
      isAdmin: false,
    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-blue-50 border-blue-200">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>
            • <strong>Platform Admin Badge</strong>: Shows when is_admin = true
            (red badge with shield)
          </li>
          <li>
            • <strong>Role Badge</strong>: Shows the user's app_role (coach,
            player, etc. with different colors)
          </li>
          <li>
            • <strong>Subscription Badge</strong>: Shows premium/pro tiers
            (hidden for free tier)
          </li>
          <li>
            • <strong>Multiple Badges</strong>: Users can have all three types
            simultaneously
          </li>
          <li>
            • <strong>Responsive Layout</strong>: Badges wrap nicely on smaller
            screens
          </li>
        </ul>
      </Card>
