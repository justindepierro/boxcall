  ...
  const steps: OnboardingStepConfig[] = [
    {
      ...
      description: "Let's get your team ready for success. We'll walk you through the essential setup steps to get the most out of BoxCall.",
      icon: 'trophy',
    ...
    },
    {
      ...
      description: 'Add assistant coaches, coordinators, and support staff. They\'ll help manage the team and can access relevant features based on their role.',
      icon: 'user-plus',
    ...
    },
    {
      ...
      description: 'Import your roster or add players individually. You can also send invite links for players and parents to join themselves.',
      icon: 'users',
    ...
    },
    {
      ...
      description: 'Set up your first practice or meeting. This helps establish your team calendar and gets everyone synchronized.',
      icon: 'calendar-plus',
      estimatedTime: '2 minutes',
    ...
    },
    {
      ...
      description: 'Take a quick tour of playbooks, messaging, attendance tracking, and other tools that will help you coach more effectively.',
      icon: 'compass',
      estimatedTime: '3 minutes',
      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        {currentStep === 'invite-coaches' && (
          <div className="mt-8 p-4 bg-jade-50 dark:bg-jade-900/20 rounded-lg border border-jade-200 dark:border-jade-800">
            <div className="flex items-start gap-3">
              <Icon name="lightbulb" size="sm" className="text-jade-600 dark:text-jade-400 mt-0.5" />
              <div className="text-left">
                ...
                <Typography variant="body-sm" className="text-jade-700 dark:text-jade-300">
                  Invite assistant coaches, coordinators, and team managers. Each role has different permissions to help manage your team effectively.
                </Typography>
              </div>
            </div>
          </div>
        ...
        {currentStep === 'add-players' && (
          <div className="mt-8 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-start gap-3">
              <Icon name="upload" size="sm" className="text-blue-600 dark:text-blue-400 mt-0.5" />
              <div className="text-left">
                <Typography variant="body-sm" className="font-medium text-blue-800 dark:text-blue-200 mb-1">
                  Multiple Ways to Add Players
                </Typography>
                <Typography variant="body-sm" className="text-blue-700 dark:text-blue-300">
                  Upload a CSV roster, add players manually, or send invite links for self-registration. Parents can also be included in communications.
                </Typography>
              </div>
            </div>
          </div>
