...
export const PracticeScriptPDF: React.FC<PracticeScriptPDFProps> = ({
  ...
  const totalRepetitions = script.plays.reduce(
      ...
      <Page size="A4" style={styles.page}>
          ...
          {script.plays.map((scriptPlay, index) => (
            <View key={scriptPlay.id} style={styles.playItem}>
              ...
              <Text style={styles.playDetails}>
                Formation: {scriptPlay.play?.formation || "Unknown"} • Type:{" "}
                {scriptPlay.play?.p_type || "Unknown"}
              </Text>
            </View>
          ))}
        </View>
        ...
        <View style={styles.summary}>
          ...
          <Text style={styles.summaryText}>
            ...
            {totalPlays > 0 ? Math.round(estimatedDuration / totalPlays) : 0}{" "}
            minutes
          </Text>
        </View>
      </Page>
