        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs bg-surface-card border border-border text-content-primary hover:bg-surface-muted rounded-md font-medium transition-colors"
          ...
          <button
            ...
            className="px-4 py-2 text-sm bg-blue-500 text-white hover:bg-blue-600 rounded-full font-medium transition-colors flex items-center gap-2 shadow-sm"
            title="Add Player"
          >
          ...
          <button
            ...
            disabled={players.length === 0}
            className={`px-4 py-2 text-sm rounded-full font-medium transition-colors flex items-center gap-2 shadow-sm ${
              players.length > 0
                ? "bg-surface-tertiary text-content-secondary hover:bg-error-100 hover:text-error-700"
