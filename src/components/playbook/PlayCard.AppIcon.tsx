    ...
    return (
      <div className="relative flex flex-col items-center w-full max-w-[180px] mx-auto overflow-visible">
        ...
        <button
          ...
          className={`relative w-[140px] h-[140px] rounded-2xl bg-gradient-to-br ${getTypeGradient(play.p_type)} shadow-lg hover:shadow-2xl transition-transform duration-200 hover:scale-105 active:scale-95 before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-tr before:from-transparent before:via-white/20 before:to-transparent before:opacity-50 before:pointer-events-none overflow-visible ${
