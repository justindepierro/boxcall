    ...
    <div className="relative z-50">
      ...
      >
        <div className="flex-1 text-left">
          ...
          <Typography variant="body-sm" className="text-text-primary font-semibold leading-tight">
              ...
              {playbooks.map((playbook) => (
                ...
                >
                  {editingId === playbook.id ? (
                    // Edit Mode
                    <div className="flex-1 flex items-center gap-spacing-xs" onClick={(e) => e.stopPropagation()}>
                      <input
                        type="text"
                        value={editingName}
                        ...
                        <div className="flex items-center gap-spacing-sm">
                          <div className="flex-1">
                            ...
                            <Typography variant="caption" className="text-text-secondary">
                              {playbook.play_count || 0} play{playbook.play_count !== 1 ? 's' : ''}
                            </Typography>
                          </div>
                          {playbook.id === activePlaybookId && (
