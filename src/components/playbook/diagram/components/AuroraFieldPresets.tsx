...
export const AuroraFieldPresets = memo<AuroraFieldPresetsProps>(({ activePreset, onPresetSelect }) => {
  return (
    <div className="backdrop-blur-xl bg-white/90 dark:bg-slate-900/90 rounded-[28px] border-2 border-white/30 dark:border-slate-700/30 p-4 shadow-2xl">
      ...
      <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-200 dark:border-slate-700">
        <Icon name="book" className="w-5 h-5 text-slate-600 dark:text-slate-400" />
        <h3 className="font-bold text-lg text-slate-900 dark:text-white">Field View</h3>
      </div>
      ...
      <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-700">
        <div className="flex items-start gap-2 p-2 rounded-xl bg-electric-50 dark:bg-electric-900/20">
          <Icon name="info" className="w-4 h-4 text-electric-600 dark:text-electric-400 mt-0.5" />
          <p className="text-xs text-electric-700 dark:text-electric-400 leading-relaxed">
            Select the field zone that matches your play's situation for better visualization.
          </p>
        </div>
      </div>
    </div>
