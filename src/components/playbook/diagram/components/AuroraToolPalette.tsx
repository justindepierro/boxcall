...
export const AuroraToolPalette = memo<AuroraToolPaletteProps>(({ activeTool, onToolSelect }) => {
  return (
    <div className="backdrop-blur-xl bg-white/90 dark:bg-slate-900/90 rounded-[28px] border-2 border-white/30 dark:border-slate-700/30 p-4 shadow-2xl">
      ...
      <div className="flex items-center gap-2 mb-4 pb-3 border-b border-slate-200 dark:border-slate-700">
        <Icon name="wrench" className="w-5 h-5 text-slate-600 dark:text-slate-400" />
        <h3 className="font-bold text-lg text-slate-900 dark:text-white">Tools</h3>
      </div>
