                ...
                <div className="space-y-6">
                  ...
                  {activeTeamId ? (
                    ...
                    <div className="rounded-2xl border border-dashed border-border bg-surface-secondary/60 px-10 py-12 text-center">
                      <Icon
                        name="users"
                        className="mx-auto mb-4 h-14 w-14 text-muted"
                      />
                      <Typography
                        variant="headline-sm"
                      ...
                      >
                        Choose a roster from the top navigation to unlock shared
                        practice templates, personnel-aware durations, and
                        assistant access controls.
                      </Typography>
                      <div className="mt-6 grid gap-3 text-left text-sm text-secondary md:grid-cols-2">
                        {teamSetupChecklist.map((item) => (
                          <div
                            key={item}
                          ...
                          >
                            <Icon
                              name="check"
                              className="mt-0.5 h-4 w-4 text-brand-jade"
                            />
                            <span>{item}</span>
                          </div>
                        ))}
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-2xl border border-dashed border-border bg-surface-secondary/60 px-8 py-12 text-center">
                    ...
                    <Typography
                      ...
                      className="text-secondary mx-auto max-w-2xl"
                    >
                      Use Brian Billick's situational framework to script
                      answers for every down, distance, and personnel grouping
                      before you hit the field on Friday night.
                    </Typography>
