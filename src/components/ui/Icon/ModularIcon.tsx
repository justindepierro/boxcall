...
export type ModularIconName = 
  | "menu" | "close" | "plus" | "edit" | "delete" | "check"
  | "calendar" | "clock" | "users" | "user" | "target"
...
const iconRegistry = new Map<string, React.ComponentType<{ size?: number; color?: string; strokeWidth?: number; className?: string }>>();
...
export const ModularIcon: React.FC<ModularIconProps> = ({
  ...
  const [IconComponent, setIconComponent] = React.useState<React.ComponentType<{ size?: number; color?: string; strokeWidth?: number; className?: string }> | null>(null);
  ...
  if (loading || !IconComponent) {
    ...
    return <div className={`inline-block animate-pulse bg-gray-200 rounded ${className}`} style={{ 
...
export const ModularPlayIcon: React.FC = () => <ModularIcon name="play" color="jade" />;
export const ModularEditIcon: React.FC = () => <ModularIcon name="edit" size="sm" color="slate" />;
export const ModularDeleteIcon: React.FC = () => <ModularIcon name="delete" size="sm" color="error" />;
export const ModularAddIcon: React.FC = () => <ModularIcon name="plus" color="jade" />;
export const ModularCalendarIcon: React.FC = () => <ModularIcon name="calendar" color="navy" />;
export const ModularClockIcon: React.FC = () => <ModularIcon name="clock" color="slate" />;
export const ModularTeamIcon: React.FC = () => <ModularIcon name="users" color="navy" />;
export const ModularSettingsIcon: React.FC = () => <ModularIcon name="settings" color="slate" />;
