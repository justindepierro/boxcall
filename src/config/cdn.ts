...
export const cdnConfig = {
  ...
  cacheControl: {
    images:
      import.meta.env.VITE_IMAGE_CACHE_CONTROL ||
      "public, max-age=31536000, immutable",
    scripts:
      import.meta.env.VITE_SCRIPT_CACHE_CONTROL ||
      "public, max-age=31536000, immutable",
    styles:
      import.meta.env.VITE_STYLE_CACHE_CONTROL ||
      "public, max-age=31536000, immutable",
    fonts:
      import.meta.env.VITE_FONT_CACHE_CONTROL ||
      "public, max-age=31536000, immutable",
  },
  ...
  preload: {
    ...
    maxConcurrentPreloads:
      Number(import.meta.env.VITE_MAX_CONCURRENT_PRELOADS) || 3,
  ...
  performance: {
    maxImageSize:
      Number(import.meta.env.VITE_MAX_IMAGE_SIZE) || 2 * 1024 * 1024, // 2MB
    lazyLoadingThreshold:
      Number(import.meta.env.VITE_LAZY_LOADING_THRESHOLD) || 0.1,
    lazyLoadingRootMargin:
      import.meta.env.VITE_LAZY_LOADING_ROOT_MARGIN || "50px",
    criticalImageTimeout:
      Number(import.meta.env.VITE_CRITICAL_IMAGE_TIMEOUT) || 3000,
  },
  ...
  development: {
    ...
    showPerformanceMetrics:
      import.meta.env.VITE_DEV_SHOW_PERFORMANCE === "true",
  },
};
...
export function validateCDNConfig() {
  ...
  // Check cache control
  if (
    !cdnConfig.cacheControl.images.includes("max-age") &&
...
export function logCDNConfig() {
  if (!import.meta.env.DEV && !cdnConfig.development.showPerformanceMetrics)
    return;
