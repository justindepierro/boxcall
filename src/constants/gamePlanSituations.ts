...
export type BillickSituationType =
  (typeof BILLICK_SITUATIONS)[keyof typeof BILLICK_SITUATIONS];
...
export const BILLICK_SITUATION_CONFIGS: Record<
  BillickSituationType,
  BillickSituationConfig
> = {
 ...
 */
export function getBillickSituation(
  type: BillickSituationType
): BillickSituationConfig {
 ...
 */
export function isValidBillickSituation(
  type: string
): type is BillickSituationType {
  return Object.values(BILLICK_SITUATIONS).includes(
    type as BillickSituationType
  );
}
