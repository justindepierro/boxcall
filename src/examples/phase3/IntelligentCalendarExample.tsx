      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-slate-600">
            Experience the next generation of sports team scheduling with AI-powered intelligence
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-slate-800 mb-3">🏗️ Architecture</h3>
              <ul className="space-y-2 text-sm text-slate-600">
                <li>• <strong>ConflictDetectionService:</strong> AI-powered conflict analysis</li>
                <li>• <strong>SmartSchedulingOptimizer:</strong> ML-based timing recommendations</li>
                <li>• <strong>AttendanceAnalyticsService:</strong> Predictive attendance modeling</li>
                <li>• <strong>IntelligentCalendarService:</strong> Unified orchestration layer</li>
                <li>• <strong>useIntelligentCalendar:</strong> React hook for frontend integration</li>
              </ul>
            </div>
            
            <div>
              <h3 className="text-lg font-semibold text-slate-800 mb-3">🔧 Implementation</h3>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <p className="text-sm text-blue-700">Cross-Platform Integration</p>
              </div>
