...
export function useSEO(metadata: SEOMetaData = {}) {
  ...
  const updateMetaTags = useCallback(
    (meta: SEOMetaData) => {
      ...
      const keywords =
        meta.keywords?.join(", ") || seoConfig.defaultMeta.keywords.join(", ");
      ...
      updateMetaTag(
        "",
        seoConfig.openGraph.imageWidth.toString(),
        "og:image:width"
      );
      updateMetaTag(
        "",
        seoConfig.openGraph.imageHeight.toString(),
        "og:image:height"
      );
      ...
      if (meta.type === "article") {
        ...
        if (meta.publishedTime)
          updateMetaTag("", meta.publishedTime, "article:published_time");
        if (meta.modifiedTime)
          updateMetaTag("", meta.modifiedTime, "article:modified_time");
