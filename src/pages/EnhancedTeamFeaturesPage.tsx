...
export function EnhancedTeamFeaturesPage({
  ...
  const teamMembers = [
    {
      ...
      current_role: "head_coach" as CalendarRole,
    },
    {
      id: "user2",
      name: "Jane Player",
      email: "jane@example.com",
      current_role: "player" as CalendarRole,
    },
    {
      id: "user3",
      name: "Bob Parent",
      email: "bob@example.com",
      current_role: "parent" as CalendarRole,
    },
    {
      id: currentUserId,
      name: "Current User",
          ...
          <EventPollingInterface
            ...
            userRole={
              ...
              userRole === "assistant_coach"
                ? "coach"
                : userRole === "parent" || userRole === "parent_admin"
                  ? "parent"
                  : "player"
            }
            canCreatePolls={["owner", "head_coach", "assistant_coach"].includes(
              userRole
            )}
          />
        );
        ...
        if (!selectedEventId) {
          return (
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Select an event from the calendar to manage advanced RSVP
                features.
              </p>
            </div>
          );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {(activeTab === "polling" || activeTab === "rsvp") &&
        !selectedEventId && (
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-90">
                    Go to your calendar to choose an event first.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center">
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Demo Mode:</strong> This is a demonstration of Phase 2.3
              Enhanced Team Features.
            </p>
            <div className="mt-2">
