...
function CoachOK() { return <div>OK_COACH</div>; }
function PlayerOK() { return <div>OK_PLAYER</div>; }
...
describe("dashboard role loaders", () => {
  beforeEach(() => { hoisted.userId = "u1"; hoisted.role = "coach"; });

  it("coach dashboard allows coach via requireCoachOrAdminLoader", async () => {
    const router = createMemoryRouter([
      { path: "/coach", loader: requireCoachOrAdminLoader, element: <CoachOK /> },
