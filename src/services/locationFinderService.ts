...
export class LocationFinderService {
   ...
   */
  static async getSchoolDistrict(address: AddressSuggestion): Promise<string | null> {
    ...
    try {
      ...
      const district = this.mockSchoolDistrictLookup(address.city, address.state);
   ...
   */
  private static async reverseGeocode(lat: number, lng: number): Promise<AddressSuggestion | null> {
   ...
   */
  private static async mockAddressSearch(query: string): Promise<AddressSuggestion[]> {
   ...
   */
  private static mockReverseGeocode(lat: number, lng: number): AddressSuggestion {
   ...
   */
  private static formatFullAddress(address: Partial<AddressSuggestion>): string {
