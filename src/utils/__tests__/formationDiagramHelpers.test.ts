...
describe('formationDiagramHelpers', () => {
  ...
  describe('convertFormationToDiagramPlayers', () => {
    ...
    it('should use position code as jersey number fallback', () => {
      ...
      const players = convertFormationToDiagramPlayers(formationWithoutJerseyNumbers);
  ...
  describe('mergeFormationIntoDiagram', () => {
    const existingDiagram: DiagramDocument = {
      version: 2,
      players: [
        { id: 'd1', x: 30, y: 30, jerseyNumber: '50', team: 'defense', position: 'regular' },
        { id: 'd2', x: 35, y: 30, jerseyNumber: '51', team: 'defense', position: 'regular' },
        { id: 'o1', x: 10, y: 10, jerseyNumber: 'OLD', team: 'offense', position: 'regular' },
      ],
      meta: {
    ...
    it('should update meta.updatedAt timestamp', () => {
      ...
      expect(merged.meta?.updatedAt).toBeGreaterThan(existingDiagram.meta?.updatedAt || 0);
    });
  ...
  describe('clearFormationFromDiagram', () => {
    const mixedDiagram: DiagramDocument = {
      version: 2,
      players: [
        { id: 'o1', x: 10, y: 10, jerseyNumber: '1', team: 'offense', position: 'regular' },
        { id: 'o2', x: 15, y: 10, jerseyNumber: '2', team: 'offense', position: 'regular' },
        { id: 'd1', x: 30, y: 30, jerseyNumber: '50', team: 'defense', position: 'regular' },
      ],
      meta: {
        createdAt: Date.now(),
    ...
    it('should count offense players only', () => {
      const mixedDiagram: DiagramDocument = {
        ...
        players: [
          { id: 'o1', x: 10, y: 10, jerseyNumber: '1', team: 'offense', position: 'regular' },
          { id: 'o2', x: 15, y: 10, jerseyNumber: '2', team: 'offense', position: 'regular' },
          { id: 'o3', x: 20, y: 10, jerseyNumber: '3', team: 'offense', position: 'regular' },
          { id: 'd1', x: 30, y: 30, jerseyNumber: '50', team: 'defense', position: 'regular' },
          { id: 'd2', x: 35, y: 30, jerseyNumber: '51', team: 'defense', position: 'regular' },
        ],
      };
