...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "BoxCall professional color system featuring jade green and navy blue for authoritative football coaching interfaces.",
      },
    },
  },
} satisfies Meta;
  ...
  render: () => (
    <div className="space-y-6">
      ...
      <div className="bg-jade-50 p-6 rounded-lg border border-jade-200">
        <h3 className="text-xl font-semibold text-jade-900 mb-4">
