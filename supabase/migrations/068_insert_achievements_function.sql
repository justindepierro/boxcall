-- Create a function to insert achievements that can be called with proper privileges
...
-- Call the function to insert achievements
SELECT insert_default_achievements();

-- Clean up the function
DROP FUNCTION insert_default_achievements();