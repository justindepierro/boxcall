-- Temporarily allow inserts for data seeding
CREATE POLICY "Temporary insert policy for seeding" ON achievement_definitions
...
DROP POLICY "Temporary insert policy for seeding" ON achievement_definitions;